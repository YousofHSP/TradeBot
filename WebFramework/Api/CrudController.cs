...
public class CrudController<TDto, TResDto, TEntity>(
    ...
    IRepository<Role> roleRepository,
    RoleManager<Role> roleManager)
    : CrudController<TDto, TResDto, TEntity, int>(repository, mapper, hashEntityValidator, roleRepository, roleManager)
...
public class CrudController<TDto, TEntity>(
    ...
    IRepository<Role> roleRepository,
    RoleManager<Role> roleManager)
    : CrudController<TDto, TDto, TEntity, int>(repository, mapper, hashEntityValidator, roleRepository,
        roleManager)
    where TEntity : class, IEntity<int>
    where TDto : BaseDto<TDto, TEntity, int>;